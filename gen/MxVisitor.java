...
public interface MxVisitor<T> extends ParseTreeVisitor<T> {
	...
	/**
	 * Visit a parse tree produced by {@link MxParser#memberDeclarationStatement}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitMemberDeclarationStatement(MxParser.MemberDeclarationStatementContext ctx);
	/**
